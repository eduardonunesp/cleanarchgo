...
func (_m *MockRideRepository) HasActiveRideByDriverID(driverID string) (bool, error) {
...
// MockRideRepository_HasActiveRideByDriverID_Call is a *mock.Call that shadows Run/Return methods with type explicit version for method 'HasActiveRideByDriverID'
type MockRideRepository_HasActiveRideByDriverID_Call struct {
	*mock.Call
}

// HasActiveRideByDriverID is a helper method to define mock.On call
//   - driverID string
func (_e *MockRideRepository_Expecter) HasActiveRideByDriverID(driverID interface{}) *MockRideRepository_HasActiveRideByDriverID_Call {
	return &MockRideRepository_HasActiveRideByDriverID_Call{Call: _e.mock.On("HasActiveRideByDriverID", driverID)}
}

func (_c *MockRideRepository_HasActiveRideByDriverID_Call) Run(run func(driverID string)) *MockRideRepository_HasActiveRideByDriverID_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(string))
	})
	return _c
...
func (_c *MockRideRepository_HasActiveRideByDriverID_Call) Return(_a0 bool, _a1 error) *MockRideRepository_HasActiveRideByDriverID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *MockRideRepository_HasActiveRideByDriverID_Call) RunAndReturn(run func(string) (bool, error)) *MockRideRepository_HasActiveRideByDriverID_Call {
	_c.Call.Return(run)
	return _c
}
